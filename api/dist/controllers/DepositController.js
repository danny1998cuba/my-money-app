...
function getAll(_, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const deposits = yield services_1.DepositService.getAll();
        return res.status(HttpStatusCodes_1.default.OK).json({ deposits });
    });
}
function getById(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const deposit = yield services_1.DepositService.getById(id);
            return res.status(HttpStatusCodes_1.default.OK).json({ deposit });
        }
        catch (error) {
