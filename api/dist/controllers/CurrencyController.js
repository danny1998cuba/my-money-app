...
function getAll(_, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const currencies = yield services_1.CurrencyService.getAll();
        return res.status(HttpStatusCodes_1.default.OK).json({ currencies });
    });
}
function getById(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const currency = yield services_1.CurrencyService.getById(id);
            return res.status(HttpStatusCodes_1.default.OK).json({ currency });
        }
        catch (error) {
...
function add(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { curr } = req.body;
            yield services_1.CurrencyService.addOne(curr);
...
function update(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { curr } = req.body;
            yield services_1.CurrencyService.updateOne(curr);
...
function delete_(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const id = +req.params.id;
            yield services_1.CurrencyService.delete(id);
            return res.status(HttpStatusCodes_1.default.OK).end();
        }
        catch (error) {
            if (error instanceof classes_1.RouteError)
