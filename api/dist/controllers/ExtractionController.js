...
function getAll(_, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const extractions = yield services_1.ExtractionService.getAll();
        return res.status(HttpStatusCodes_1.default.OK).json({ extractions });
    });
}
function getById(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const extraction = yield services_1.ExtractionService.getById(id);
            return res.status(HttpStatusCodes_1.default.OK).json({ extraction });
        }
        catch (error) {
...
function add(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield services_1.ExtractionService.addOne(extraction);
...
function update(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { extraction } = req.body;
            yield services_1.ExtractionService.updateOne(extraction);
...
function delete_(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const id = +req.params.id;
            yield services_1.ExtractionService.delete(id);
            return res.status(HttpStatusCodes_1.default.OK).end();
        }
        catch (error) {
            if (error instanceof classes_1.RouteError)
